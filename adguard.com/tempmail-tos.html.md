# AdGuard Temp Mail Terms of Service

*September 25, 2026*

IMPORTANT: THESE TERMS OF SERVICE (“TERMS”) ARE A LEGAL AGREEMENT BETWEEN YOU (AN INDIVIDUAL) AND ADGUARD SOFTWARE LIMITED (OWNER OF ALL RIGHTS, WHETHER EXCLUSIVE OR OTHERWISE, TO THE SERVICE). THEY GOVERN YOUR ACCESS TO AND USE OF ADGUARD TEMP MAIL, INCLUDING ALL RELATED FEATURES AND FUNCTIONS.

READ THESE TERMS CAREFULLY BEFORE USING ADGUARD TEMP MAIL. BY ACCESSING OR USING ADGUARD TEMP MAIL, INCLUDING BY GENERATING OR USING A TEMPORARY EMAIL ADDRESS, YOU CONFIRM YOUR ACCEPTANCE OF THE SERVICE AND AGREE TO BECOME BOUND BY THESE TERMS.

IF YOU DO NOT AGREE TO THESE TERMS, DO NOT ACCESS OR USE ADGUARD TEMP MAIL.
...
AdGuard Software Limited (“Rightholder”, “we”, “us”, “our”) may modify these Terms from time to time without prior notice. The amendment of these Terms may be broadcasted to you by publishing the updated Terms on the AdGuard Temp Mail website (adguard.com/adguard-temp-mail/overview.html, “Website”).

## 1. General

1.1. AdGuard Software Limited provides AdGuard Temp Mail (“AdGuard Temp Mail” or the “Service”), which is a browser-based temporary (disposable) email service available through the Website. You are solely and exclusively responsible for the use of AdGuard Temp Mail. AdGuard Software Limited shall not be liable for any loss, whether monetary or non-monetary, including but not limited to attorney fees or court costs, regardless of any laws or statutes that might suggest otherwise.

1.2. AdGuard Software Limited grants you a non-exclusive and limited license to access and use AdGuard Temp Mail within the scope of the functionality described on the Website, provided that you comply with all requirements, restrictions, and terms specified in these Terms. AdGuard Temp Mail is owned and copyrighted by AdGuard Software Limited and is protected worldwide. AdGuard Software Limited retains all rights, title, and interest in and to AdGuard Temp Mail and any portion thereof, including, without limitation, all copyrights, trademarks, service marks, trade secrets, and other intellectual property rights. All rights are reserved unless otherwise noted. Modifying, distributing to unauthorized parties, reverse engineering, or otherwise using AdGuard Temp Mail in any way not expressly authorized by AdGuard Software Limited with written consent or permitted by these Terms is strictly prohibited.

1.3. AdGuard Temp Mail does not require registration, an account, or a subscription. A temporary email address is generated for you automatically when you access the Service. A cookie containing a unique identifier is stored in your browser to recognize it on your next visit and keep the same temporary email address available. Clearing your browser data removes this cookie and may result in the loss of access to that address and to any messages in it.

1.4. AdGuard Temp Mail is subject to various usage limits. These limits include, but are not limited to, the number of temporary email addresses, message size, attachment handling, message storage periods, available domains. Limits may be modified at any time, with or without prior notice, to protect the Service, prevent abuse, maintain deliverability, or comply with legal or technical requirements.
...
1.6. Your continued use of AdGuard Temp Mail after any modifications to these Terms have been made will constitute your acceptance of such modifications.
...
2.5. Only persons 18 years of age or older may use AdGuard Temp Mail. You are not allowed to use AdGuard Temp Mail if you are a minor or if you have been or are prohibited from accessing the Service.
...
3.4. We may limit, disable, delete, rotate, replace, or refuse to provide temporary addresses, domains, or storage when necessary to operate the Service, prevent abuse, protect deliverability or domain reputation, comply with law, or enforce these Terms.

## 4. Retention Limits

4.1. AdGuard Temp Mail operates under specific time-based constraints. Temporary email addresses and the messages in them are deleted automatically: after 7 days, if you do not open or refresh an email address during that period; after 6 months of use, which is the maximum lifetime of an email address; and immediately, if you generate a new temporary email address. All received emails are accessible as long as the temporary email address remains active. Upon deletion of an address, the associated emails are physically deleted and no new emails are accepted.
...
8.3. Restriction on Amendments. No Rightholder Partner, or agent or employee of a Rightholder Partner, is authorized to make any amendment to these ToS. Any conflict or ambiguity between these ToS and any separate terms or conditions provided by a Rightholder Partner regarding the services shall be resolved in favor of these ToS.

8.4. Severability. If any provision of these ToS shall be held by a court of competent jurisdiction to be contrary to law, that provision will be enforced to the maximum extent permissible, and the remaining provisions of these ToS will remain in full force and effect.
