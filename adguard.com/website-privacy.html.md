...
- Visit websites related to AdGuard software and services (hereafter, the “Websites”):
    ...
    - AdGuard’s checkout webpage at [adguardcheckout.com](https://adguardcheckout.com).
...
If you choose to register your account using your third-party account, such as a Google, Apple, or Facebook account, we will process an authentication token to prove your identity. AdGuard does not request or have access to your third-party accounts.
...
If you enable the *Send read receipts to AdGuard* option in *Settings* → *Email subscriptions*, we will collect data indicating whether you have opened our emails or clicked any links in them. To do this, we embed a small image linked to our server in each email, which allows us to register opens associated with a specific mailing ID. This data is anonymized. We do not use third-party email clients or share this data with any external parties. You can opt out of sending read receipts at any time by disabling this option in your settings.
...
None of the information we may collect through cookies is considered Personal Data as it does not allow us to identify you. You can always disable or clear cookies in your browser, but please note that some of our services may not function properly without the aid of cookies.
