...
> **Основная идея:** Adguard не передаёт и не продаёт третьим лицам ваши личные данные. Главные принципы, которым мы привержены: бороться за приватность пользователей и быть максимально прозрачными - это главные принципы, которым мы привержены.
...
Общий принцип нашей политики конфиденциальности - собирать только ту информацию, которая необходима для обеспечения полной функциональности наших продуктов и предоставления лицензий. Мы не передаем данные третьим лицам.

## Как мы получаем информацию?

В нашем случае есть несколько способов получения данных:
