...
2.3. Если вы не отменили автооплату, средства будут списаны с вашего счёта автоматически, и лицензия AdGuard будет продлена. Если вы отключите автоматическое продление, то до истечения срока действия лицензии AdGuard получите письмо с условиями продления на электронный адрес, указанный при первой покупке. Также мы заранее уведомим вас о повышении цен на лицензии AdGuard.
